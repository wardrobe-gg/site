...
export function NewHeader() {
    ...
    return (
        <div className="mb-[16vh] relative z-[100]"><div className="h-[10vh] w-full bg-oblack flex justify-between items-end border-b fixed top-0 lg:mb-[4rem] px-4 lg:px-[8rem] z-[100]">
        <div className="flex gap-8 h-full w-full items-center">
            <NavigationMenu>
                <NavigationMenuList>
                    <NavigationMenuItem>
