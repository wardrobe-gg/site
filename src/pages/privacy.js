                ...
                <div className="flex flex-col gap-2 items-center p-4 lg:p-10 text-center">
                    ...
                    <div className="text-left">
                        ...
                        <div class="w-7/12 flex flex-col gap-4">
                            ...
                            <span>
                                <LegalBold>Payment Data.</LegalBold> <span>We may collect data necessary to process your payment if you make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is stored by Stripe and PayPal. You may find their privacy notice link(s) here: <LegalLink to={'https://stripe.com/en-gb/privacy'}>https://stripe.com/en-gb/privacy</LegalLink> and <LegalLink to={'https://www.paypal.com/webapps/mpp/ua/privacy-full'}>https://www.paypal.com/webapps/mpp/ua/privacy-full</LegalLink>.</span>
                            </span>
                            <span>
